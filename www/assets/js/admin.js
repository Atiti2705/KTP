  ...
  async syncFirestore() {
    if (FirebaseConfig.isConfigured && FirebaseConfig.db) {
      try {
        ...
        const [photos, docs, mipuiaw, sermons, announcements, lyrics, ob_members, settings] = await Promise.all([
        ...
        if (Array.isArray(ob_members)) localStorage.setItem('db_ob_members', JSON.stringify(ob_members));
...
function renderSidebar() {
  ...
  sidebar.innerHTML = `
    ...
    <div class="sidebar-nav">
      ...
      <a href="mipui-aw.html" class="sidebar-link ${activePage === 'mipuiaw' ? 'active' : ''}">
        <span class="link-icon">📰</span> Mipui Aw Publications
      </a>
      <a href="documents.html" class="sidebar-link ${activePage === 'documents' || activePage === 'sermons' ? 'active' : ''}">
        <span class="link-icon">📄</span> Documents
      </a>
      ...
      <a href="office-bearers.html" class="sidebar-link ${activePage === 'ob' ? 'active' : ''}">
        <span class="link-icon">👥</span> Office Bearers
      </a>
