    ...
    <div class="footer-content">
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          ...
          <div class="social-links">
            <a href="${SocialMedia.instagram.url}" target="_blank" rel="noopener" class="social-link instagram" aria-label="Instagram" title="Follow on Instagram">📷</a>
            <a href="${SocialMedia.facebook.url}" target="_blank" rel="noopener" class="social-link facebook" aria-label="Facebook" title="Like on Facebook">📘</a>
            <a href="${SocialMedia.youtube.url}" target="_blank" rel="noopener" class="social-link youtube" aria-label="YouTube" title="Subscribe on YouTube">▶️</a>
          </div>
        </div>
      ...
      <div class="footer-bottom">
        ...
        <div class="social-links" style="gap: 8px;">
          <a href="${SocialMedia.instagram.url}" target="_blank" rel="noopener" class="social-link instagram" style="width:32px;height:32px;font-size:14px;" aria-label="Instagram">📷</a>
          <a href="${SocialMedia.facebook.url}" target="_blank" rel="noopener" class="social-link facebook" style="width:32px;height:32px;font-size:14px;" aria-label="Facebook">📘</a>
          <a href="${SocialMedia.youtube.url}" target="_blank" rel="noopener" class="social-link youtube" style="width:32px;height:32px;font-size:14px;" aria-label="YouTube">▶️</a>
        </div>
      </div>
